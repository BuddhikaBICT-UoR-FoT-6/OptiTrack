        ...
        <div className="min-h-screen bg-[#020617] flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="w-full max-w-[440px] relative z-10">
                ...
                <div className="text-center mb-8 animate-in fade-in slide-in-from-top-4 duration-1000">
                    <div className="inline-flex p-4 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-[24px] mb-6 shadow-2xl shadow-blue-600/20 ring-1 ring-white/20">
                        <Truck size={32} className="text-white" />
                    </div>
                    <h1 className="text-4xl font-black text-white tracking-tighter mb-2">
                        OPTITRACK<span className="text-blue-500">.</span>
                    </h1>
                    <p className="text-slate-500 font-medium tracking-wide uppercase text-[10px]">Autonomous Logistics Intelligence Suite</p>
                </div>

                {/* Glassmorphic Command Module */}
                <div className="bg-white/[0.03] backdrop-blur-[32px] border border-white/10 p-10 rounded-[40px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] ring-1 ring-white/5 animate-in zoom-in-95 duration-700">
                    <div className="flex bg-black/20 p-1.5 rounded-2xl mb-10 ring-1 ring-white/5">
                        <button 
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2 animate-in slide-in-from-left-4">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        type="email"
                                        required
                                        className="w-full pl-12 pr-4 py-4 bg-black/20 border border-white/5 rounded-2xl text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-600/40 focus:border-blue-600/40 transition-all text-sm"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    type="text"
                                    required
                                    className="w-full pl-12 pr-4 py-4 bg-black/20 border border-white/5 rounded-2xl text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-600/40 focus:border-blue-600/40 transition-all text-sm font-mono"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-blue-600 hover:bg-blue-500 disabled:bg-blue-600/50 text-white font-black py-5 rounded-2xl shadow-xl shadow-blue-600/20 transition-all flex items-center justify-center group mt-4 overflow-hidden relative"
                        >
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:animate-[shimmer_2s_infinite] pointer-events-none" />
                            {loading ? (
                                <Loader2 className="animate-spin h-5 w-5" />
                            ) : (
                                <span className="flex items-center gap-2 text-xs tracking-[0.2em]">
                ...
                <p className="text-center mt-8 text-[10px] text-slate-600 font-bold tracking-[0.3em] uppercase">
